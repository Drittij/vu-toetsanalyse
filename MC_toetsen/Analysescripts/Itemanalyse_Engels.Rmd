...
names(toets) <- c("Total Number of Questions", "Total Number of Students", "Reliability Exam (KR-20)", "Predicted Reliability (75 questions)", "Average score", "Standard deviation scores", "Standard Error of Measurement (SEm)", "Adjusted P value exam", "P value exam", "Passing Rate", "Cut score", "Livingston's kappa")
