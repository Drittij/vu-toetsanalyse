################################################################################
### Mainscript Heranalyse 3 versies.R
################################################################################
### R code voor Tentamenanalyse Vrije Universiteit Amsterdam
###
### Bestandsnaam: Mainscript Heranalyse 3 versies.R
...
ll <- parse(file = "MC toetsen/Heranalyse Toetsanalyse 3 versies stap 1.R")
...
################################################################################
##Laden van transformatie script en errors tonen in console
ll <- parse(file = "MC toetsen/Heranalyse Toetsanalyse 3 versies stap 2.R")
