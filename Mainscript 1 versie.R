...
thetitle=naamtoets; rmarkdown::render("Itemanalyse.Rmd", output_file = paste0(Network_directory,"Itemanalyse.pdf"))
...
vraag_groep_score <- dplyr:: select(vraag_groep, studentnummer, groep1, groep2, groep3)
write.csv2(vraag_groep_score, file=paste0(Network_directory,"vraaggroepen.csv"), row.names=FALSE)
